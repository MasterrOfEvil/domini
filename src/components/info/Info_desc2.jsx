    ...
    <div>
      <div>
        ...
        <div>
          ...
          <div>
            Accès à la demande aux salles de réunion et aux bureaux de jour
          </div>
          <div>Accès sécurisé à Internet haut débit et au téléphone</div>
          <div>Accès au café, aux photocopieurs et aux télécopieurs</div>
        </div>
        <div>
          Forfaits personnalisés disponibles. Inscrivez-vous ci-dessous ou
