    ...
    <div className=" mt-10 flex flex-col items-center mb-28">
      ...
      <div className=" flex flex-col  w-[950px] mt-24">
        ...
        <h3 className="text-[16px] tracking-wide pt-3 leading-[18px] mb-6 font-[400]">
          Découvrez les avantages d'un Bureau Virtuel avec transfert de courrier
          en Suisse ! Impressionnez vos clients et prospects en utilisant une
          adresse en Suisse, le tout sans quitter le confort de votre maison.
          Recevez du courrier, des appels téléphoniques et bien plus encore,
          avec un personnel dédié pour gérer tous les aspects, de la réception
          des appels au transfert du courrier.
        </h3>
      </div>
      <div className="flex w-[950px] justify-center items-center gap-20">
        <div className="flex-1">
          ...
          <div className="mt-2 leading-[19px] text-[14px]">
            ...
            <br />
            <br />
            Quelle que soit votre raison d'intérêt pour un bureau virtuel en
            Suisse, vous bénéficierez d'un environnement de travail
        ...
        <div className="flex-1">
          ...
          <div className="mt-2 leading-[19px] text-[14px]">
            ...
            Bénéficiez d'une prestigieuse adresse virtuelle avec des options
            telles qu'un numéro de téléphone local, un numéro de fax, la gestion
            du courrier, la numérisation et le transfert du courrier, ainsi que
            la réception en direct et bien plus encore. Établissez votre
            présence au bureau virtuel en Suisse du jour au lendemain, avec
            accès aux salles de réunion, aux salles de conférence, aux bureaux
            de jour et à l'espace de réception. Profitez d'un service
            personnalisé de notre équipe de réception pour faire prospérer votre
            entreprise où que vous soyez en Suisse.
          </div>
        </div>
      </div>
    </div>
